...
import mine.demo1.okhttp_qcloud.https.builder.GetBuilder;
import mine.demo1.okhttp_qcloud.https.builder.PostBytesBuilder;
import mine.demo1.okhttp_qcloud.https.builder.PostFileBuilder;
import mine.demo1.okhttp_qcloud.https.builder.PostFormBuilder;
import mine.demo1.okhttp_qcloud.https.builder.PostStringBuilder;
import mine.demo1.okhttp_qcloud.https.callback.Callback;
import mine.demo1.okhttp_qcloud.https.https.HttpsUtils;
...
public class OkHttpUtils
{
    ...
    public static PostBytesBuilder postByte()
    {
